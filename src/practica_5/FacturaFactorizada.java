...
public class FacturaFactorizada {
	...
	public FacturaFactorizada(Iva iva, Deduccion deduccion) {
		...
		codigo = rdm.nextInt(10) + "" + rdm.nextInt(10) + "" + rdm.nextInt(10) + "" + rdm.nextInt(10) + ""
	...
	public double CalcularTotal() {
		...
		//Devolvemos el importe total, esto sera de ayuda para los tests
        	return importeTotal;
	}
	...
	public void setImporteTotal(double importeFactura) {
		this.importeTotal = importeFactura;
	}
