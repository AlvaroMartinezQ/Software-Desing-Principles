...
public class TestSingleton {
	...
	public void ejecutarTest() {
		...
		sb.append("\n\n-Conclusiones:\n\n");
		if (equal1 && equal2)
			sb.append("Podemos concluir que el patron singleton funciona sin problemas.");
		else
			sb.append("Podemos concluir que el patron singleton tiene un fallo en su escritura.");
